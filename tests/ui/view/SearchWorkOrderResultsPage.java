...
public class SearchWorkOrderResultsPage extends Page{

    public SearchWorkOrderResultsPage(WebDriver driver) {
        super(driver);
        this.driver.get(getPath()+"Controller?command=SearchWorkOrder");
    }
